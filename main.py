...
artt = """
 ...
 ▀▄   █       █     ▀▄ █▀ ▀▄  █  ▄▀ █ █  █   █ 
   █ ▀  \033[37m▄▄▄\033[35m    ▀▀▀▀▄   █   ▀  █▀▀▌  █▄▄█ █▀▀▀  
  ▄ █        ▀▄▄▄▄▀    █▄  ▄▀ █  █  █  █ █     
 █   ▀▄                ▀███▀    █      █  █  \033[37m[\033[35m+\033[37m] By \033[37m@Akashbdbot,
  ▀                            ▀      █    ▀    [\033[37m+\033[35m] Special thanks \033[35m@Akash
                                    ▀         
"""
try:
        						...
        						for item in c:
        							if len(item) == 28 and "|" not in str(item)[0:14] and "|" not in str(item)[26:28] :
        								if item not in repeated:
        									...
        									if clord == 0:
        										clord = 1
        										print(clorr1 + str(cnter) + clorr2 + "|" + clorr1 + onichan + clorr2 + "|" + clorr1 + "A-Scrap v3.0" + clorr2 + "|" + clorr1 + "Akashbdbot" + clorr2 + "|" + clorr1 + "Akashbdbot" + clorr2 + "|" + clorr1 + "Akash")
        									elif clord == 1:
        										clord = 0
        										print(clorr2 + str(cnter) + clorr1 + "|" + clorr1 + onichan + clorr2 + "|" + clorr2 + "A-Scrap v3.0" + clorr1 + "|" + clorr2 + "Akashbdbot" + clorr1 + "|" + clorr2 + "Akashbdbot" + clorr1 + "|" + clorr2 + "Akash")
